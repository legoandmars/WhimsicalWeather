...
namespace WhimsicalWeather.Patches
{
    ...
    internal class HornPatches
    {
        ...
        {
            return WhimsicalVisuals.WhimsicalVisualsEnabled && Config.Instance.ChangeShipHornPitch.Value ? Config.Instance.ShipHornPitch.Value : 0.97f;
        }

        public static float ModifiedHornLowPitch()
        {
            return WhimsicalVisuals.WhimsicalVisualsEnabled && Config.Instance.ChangeShipHornPitch.Value ? Config.Instance.ShipHornStartPitch.Value : 0.88f;
        }
    }
}
